...
class Single_EmailList(restful.Resource):
    def __init__(self, *args, **kwargs):
        self.parser = reqparse.RequestParser()
        self.parser.add_argument('reading',type=str)
        super(Single_EmailList,self).__init__()
...
class Single_Email(restful.Resource):
...
api.add_resource(Single_EmailList, '/api/emails/')
api.add_resource(Single_Email, '/api/emails/<ObjectId:client_id>/')
